...
def common_month(df):
    '''Finds and prints the most common month for start time.
    Args:
        bikeshare dataframe
    Returns:
        none
...
def common_day(df):
    '''Finds and prints the most common day of week (Monday, Tuesday, etc.) for start time.
    Args:
        bikeshare dataframe
    Returns:
        none
...
def common_hour(df):
    '''Finds and prints the most common hour of day for start time.
    Args:
        bikeshare dataframe
    Returns:
        none
...
def common_stations(df):
    '''Finds and prints the most common start station and most common end station.
    Args:
        bikeshare dataframe
    Returns:
        none
...
def birth_years(df):
    ''' Finds and prints the earliest (i.e. oldest user), most recent (i.e.
        youngest user), and most common birth years.
    Args:
        bikeshare dataframe
    Returns:
        none
